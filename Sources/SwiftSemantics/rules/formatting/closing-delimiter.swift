            ...
            SyntaxVisitor
        {
            ...
            override func visit(
                ...
                if let rightParen = node.rightParen {
                    inspect(
                        construct: Syntax(node.calledExpression),
                        closing: rightParen,
            ...
            private func inspect(
                ...
                diagnostics.append(
                    .init(
                        ...
                        severity: .warning,
                        message:
                            "Align a multiline closing delimiter with the indentation level of the construct that opened it.",
                        file: source.file,
